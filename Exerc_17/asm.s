...
main:   
	...
	BL GPIO_enable ; habilita clock ao port N e port F
	...
	LDR R0, =GPIO_PORTN_BASE
        ...
        MOV R1, #00010001b ; bits 0 e 4 como saída (LEDs D4 e D3)
        BL GPIO_digital_output
       
        LDR R0, = GPIO_PORTN_BASE
        MOV R1, #00000011b ; máscara dos LEDs D1 e D2
        MOV R2, #00000001b ; padrão de acionamento      

        LDR R3, = GPIO_PORTF_BASE
        MOV R4, #00010001b ; máscara dos LEDs D3 e D4
        MOV R5, #00000001b ; padrão de acionamento      
...
loop:   BL GPIO_write; aciona LEDs D1,D2,D3 e D4
        ...
        EOR R2, R2, #11b    ; inverte o padrão de acionamento D1 e D2
        EOR R5, R5, #10001b ; inverte o padrão de acionamento D3 e D4
        B loop
...
wait	LDR R1, [R2]
	TST R1, R0 ; clock dos ports habilitados?
	BEQ wait
